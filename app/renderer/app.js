...
// ---------------------------------------------------------------------
// width/height jsou explicitní (ne jen spoléhání na CSS) — starší cachovaný
// obsah appky (Service Worker) může běžet se stylem, který tento selektor
// nemá, tak ikona zůstane vždy viditelná bez ohledu na CSS.
const SUN_SVG = '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/></svg>';
const MOON_SVG = '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8Z"/></svg>';
  ...
  document.getElementById("view").innerHTML = `
    <div class="panel">
      ...
      <div style="margin-top:14px;padding:12px 14px;border-radius:10px;background:${integrity.balanced ? "#eaf8f0" : "#fff0f0"};color:${integrity.balanced ? "#147a46" : "#b42318"}">
        ...
        Celkové účetní obraty: MD ${fmtMoney(integrity.md_total)} / D ${fmtMoney(integrity.d_total)} / rozdíl ${fmtMoney(integrity.difference)}
